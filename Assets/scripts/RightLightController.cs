...
public class RightLightController : MonoBehaviour 
{
	...
	void Update () 
    {
        ...
        if (Input.GetButtonDown("P1_Button3")) { p1_3.SetTrigger("register"); }
        ...
        if (Input.GetButtonDown("P2_Button3")) { p2_3.SetTrigger("register"); }
        ...
        if (Input.GetButtonDown("P3_Button3")) { p3_3.SetTrigger("register"); }
        ...
        if (Input.GetButtonDown("P4_Button3")) { p4_3.SetTrigger("register"); }
	}
}
